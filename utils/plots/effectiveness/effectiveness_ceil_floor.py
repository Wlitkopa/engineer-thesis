...
for i in range(1, 4):
    type_of_test = i
    N, regev_ceil_floor_effectiveness_1_N_1, regev_ceil_floor_effectiveness_1_p_q, time2 = extract_data("ceil_floor", type_of_test, None)

    if i == 2:
        regev_ceil_floor_effectiveness_1_N_1[0] = 98.8
        regev_ceil_floor_effectiveness_1_p_q[0] = 98.8
    ...
    plt.title(f"Comparison of effectiveness, ceil_floor, type of test {type_of_test}")
    ...
    plt.savefig(f"./../../../images/plots/effectiveness/effectiveness_ceil_floor_{type_of_test}.png")
...
for i in range(1, 4):
    ...
    plt.title(f"Comparison of effectiveness, ceil_floor")
    # plt.legend(bbox_to_anchor=(0, 0.92, 1, 0.2), loc="lower left", mode="expand", borderaxespad=0, ncol=3)
    plt.subplots_adjust(bottom=0.4)
    plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15), ncol=1, frameon=False)
    plt.grid(color='gray', linestyle='--', linewidth=0.25)

plt.savefig(f"./../../../images/plots/effectiveness/effectiveness_ceil_floor_all.png")