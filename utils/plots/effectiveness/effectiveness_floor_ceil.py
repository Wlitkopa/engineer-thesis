...
for i in range(1, 4):
    ...
    plt.plot(N[:len(regev_floor_ceil_effectiveness_1_N_1)], regev_floor_ceil_effectiveness_1_N_1,
             label="Regev's algorithm floor_ceil - square root of unity modulo N", color=colors[i-1][0])
    plt.plot(N[:len(regev_floor_ceil_effectiveness_1_p_q)], regev_floor_ceil_effectiveness_1_p_q,
             label="Regev's algorithm floor_ceil - non trivial square root of unity modulo N", color=colors[i-1][1])
