...
m_regev_ceil_ceil = [t * e for t, e in zip(regev_ceil_ceil_time_ms, factorize_effectiveness_ceil_ceil)]
m_regev_ceil_floor = [t * e for t, e in zip(regev_ceil_floor_time_ms, factorize_effectiveness_ceil_floor)]
m_regev_floor_ceil = [t * e for t, e in zip(regev_floor_ceil_time_ms, factorize_effectiveness_floor_ceil)]
m_regev_floor_floor = [t * e for t, e in zip(regev_floor_floor_time_ms, factorize_effectiveness_floor_floor)]

plt.xlabel("N - factorized number")
plt.ylabel("effectiveness * quantum time execution [h]")
...
plt.savefig("./../../images/plots/time_multiplied_by_effectiveness.png")
